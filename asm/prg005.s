...
.import Level_VertScrollH, Level_VertScroll, Player_UphillFlag, Level_TilesetIdx, Level_ChangeReset
.import Level_NoStopCnt, Level_Event, Player_IsDucking, Player_InWater, Player_Bounce, Player_BounceDir
.import Level_HAutoScroll, Player_OffScreen, PUp_StarManFlash, Player_PartDetEn, Object_SprRAM
.import SpecialObj_YVelFrac, SpecialObj_XVelFrac, SpecialObj_YLo, SpecialObj_XLo, SpecialObj_YVel
.import SpecialObj_XVel, Kill_Tally, Level_AScrlConfig, Cine_ToadKing, AScrlURDiag_WrapState_Copy
.import AScrlURDiag_WrapState, Object_TileFeet, Object_TileWall, Objects_SprHVis, Objects_SpawnIdx
.import Objects_State, Objects_Frame, Level_ObjectID, Objects_FlipBits, Objects_SprVVis, Objects_Var1
.import Objects_Var2, Objects_Timer3, Buffer_Occupied, Objects_InWater, CannonFire_Var, CannonFire_Timer
.import Level_Tileset, Map_ReturnStatus, PatTable_BankSel, World_Num, Object_VelCarry
.import Objects_TargetingXVal, Objects_TargetingYVal, Level_ScrollDiffV, Level_ScrollDiffH, RandomN
.import Objects_PlayerHitStat, Scores_Value, Scores_Counter, LRBounce_Vel, ArrowPlat_IsActive
.import BigQBlock_GotIt, Tile_Mem, Level_TreasureItem, Map_BonusType, Map_BonusCoinsReqd, EndCard_Flag
.import AScroll_Anchor, Level_AScrlSelect, Level_AScrlLimitSel, Level_AScrlVar, Level_AScrlPosV
.import Level_AScrlHVel, Level_AScrlVVel, CannonFire_ID, CannonFire_YHi, CannonFire_Y, CannonFire_XHi
.import CannonFire_X, CannonFire_Parent, Splash_DisTimer, CannonFire_Timer2, Level_ObjIdxStartByScreen
.import Level_ObjectsSpawned, Level_Objects, PlayerProj_ID, Temp_VarNP0, Lakitu_Active, LevelEvent_Cnt
.import Vert_Scroll_Off, Level_Vibration, Player_VibeDisable, Player_TwisterSpin, RotatingColor_Cnt
.import Player_DebugNoHitFlag, Tile_AttrTable, Object_TileFeet2, Object_TileWall2, Bubble_Cnt
.import Splash_Counter, BrickBust_En, CoinPUp_State, SpecialObj_ID, Objects_Var3, SpecialObj_YHi
.import Objects_SprAttr, Objects_UseShortHTest, Objects_IsGiant
; imports from PRG000
.import LevelEvent_DoNothing, Level_PrepareNewObject, AScroll_HorizontalInitMove
.import Object_ShakeAndCalcSprite, Object_ApplyYVel, Object_DeleteOffScreen_N2, Fish_FixedYIfAppro
.import Player_GetHurt, SpikesEnable, Object_GetRandNearUnusedSpr, ObjectObject_Intersect
.import Object_CalcBoundBox, Object_CalcBoundBox2, Object_HitTest, Object_DrawTallAndHFlip
.import SpecialObj_FindEmptyAbort, Score_Get100PlusPts, Object_HandleBumpUnderneath
.import Object_AnySprOffscreen, Negate, SpecialObj_FindEmptyAbortY, Level_ObjCalcYDiffs
.import Object_CalcSpriteXY_NoHi, Object_Draw16x32Sprite, Object_ApplyXVel, Object_AboutFace
.import Object_HitGround, Object_Move, Object_ShakeAndDraw, Level_ObjCalcXDiffs
.import Object_ShakeAndDrawMirrored, Object_DeleteOffScreen, Object_ApplyYVel_NoLimit
.import Object_WorldDetectN1, Player_HitEnemy, Podoboo_Splash, Object_DetermineHorzVis
...
ObjectGroup04_PatternStarts:
	...
	.byte <(ObjP90 - ObjectGroup04_PatternSets), <(ObjP91 - ObjectGroup04_PatternSets)
	.byte <(ObjP92 - ObjectGroup04_PatternSets), <(ObjP93 - ObjectGroup04_PatternSets)
	.byte <(ObjP94 - ObjectGroup04_PatternSets), <(ObjP95 - ObjectGroup04_PatternSets)
	.byte <(ObjP96 - ObjectGroup04_PatternSets), <(ObjP97 - ObjectGroup04_PatternSets)
	.byte <(ObjP98 - ObjectGroup04_PatternSets), <(ObjP99 - ObjectGroup04_PatternSets)
	.byte <(ObjP9A - ObjectGroup04_PatternSets), <(ObjP9B - ObjectGroup04_PatternSets)
	.byte <(ObjP9C - ObjectGroup04_PatternSets), <(ObjP9D - ObjectGroup04_PatternSets)
	.byte <(ObjP9E - ObjectGroup04_PatternSets), <(ObjP9F - ObjectGroup04_PatternSets)
	.byte <(ObjPA0 - ObjectGroup04_PatternSets), <(ObjPA1 - ObjectGroup04_PatternSets)
	.byte <(ObjPA2 - ObjectGroup04_PatternSets), <(ObjPA3 - ObjectGroup04_PatternSets)
	.byte <(ObjPA4 - ObjectGroup04_PatternSets), <(ObjPA5 - ObjectGroup04_PatternSets)
	.byte <(ObjPA6 - ObjectGroup04_PatternSets), <(ObjPA7 - ObjectGroup04_PatternSets)
	.byte <(ObjPA8 - ObjectGroup04_PatternSets), <(ObjPA9 - ObjectGroup04_PatternSets)
	.byte <(ObjPAA - ObjectGroup04_PatternSets), <(ObjPAB - ObjectGroup04_PatternSets)
	.byte <(ObjPAC - ObjectGroup04_PatternSets), <(ObjPAD - ObjectGroup04_PatternSets)
	.byte <(ObjPAE - ObjectGroup04_PatternSets), <(ObjPAF - ObjectGroup04_PatternSets)
	.byte <(ObjPB0 - ObjectGroup04_PatternSets), <(ObjPB1 - ObjectGroup04_PatternSets)
	.byte <(ObjPB2 - ObjectGroup04_PatternSets), <(ObjPB3 - ObjectGroup04_PatternSets)
...
PRG005_A947:
	...
	CLC
	ADC Prop_UpperYOff,X	; Add Y offset to upper sprite Y
...
PRG005_ABC0:
	CLC
	ADC Objects_Frame,X	; Add current frame value
...
PRG005_AC6B:
	...
	PHA		 ; Save bolt's X
	CLC
	ADC Temp_Var1	 ; Add decided value
...
PRG005_AD37:
	CLC
	ADC Objects_X,X ; Sun moves by horizontal scroll
...
PRG005_AE39:
	CLC
	ADC Sun_VelAccel,Y	 ; Apply acceleration to X velocity
...
PRG005_AE50:
	CLC
	ADC Sun_VelAccel,Y	 ; Apply acceleration to Y velocity
...
PRG005_AFB8:
	...
	SEC
	SBC Temp_Var1	 ; Subtract the detected tile
	CMP #$02
...
PRG005_B175:
	CLC
	ADC Player_X	; Offset Player's X
	STA Player_X	; Set it!
...
PRG005_B852:
	...
	ASL A		 
	CLC
	ADC Temp_Var2	 ; Multiply by 3 (get to appropriate object)
	TAY		 ; -> 'Y'
...
PRG005_B8F3:
	...
	CLC
	ADC #$01	 ; +1 (because zero means "empty/unused" in Cannon Fire)
...
PRG005_BD33:
	CLC
	ADC Horz_Scroll 	; Horz_Scroll + X offset
...
LevelEvent_SpikeCheep:
	...
	LDA Horz_Scroll
	CLC
	ADC SpikeCheepX,Y	; Start on left or right of screen
	STA Objects_X,X
	LDA Horz_Scroll_Hi
	ADC #$00
	STA Objects_XHi,X
	...
	CLC
	ADC Level_AScrlHVel	 ; Otherwise, apply auto scroll's horizontal delta to Spike Cheep's X velocity
